...
import com.HTTN.thitn.mapper.ChoiceMapper;
...
public class ChoiceController {
    ...
    public ResponseEntity<List<ChoiceResponse>> getChoicesByQuestion(@PathVariable Integer questionBankId) {
    ...
    public ResponseEntity<List<ChoiceResponse>> getChoicesForStudentByQuestion (@PathVariable Integer questionBankId) {
        List<Choice> choices = choiceService.getChoicesByQuestion(questionBankId);
        List<ChoiceResponse> responses = choices.stream()
                .map(choiceMapper::toStudentResponse)
                .toList();
        return ResponseEntity.ok(responses);
    }
