...
const ExamRoutes = () => [
  ...
  <Route
    path="/student/subject/:subjectId/exams"
    element={
      <ProtectedRoute allowedRoles={["student"]}>
        <HsExamPage />
      </ProtectedRoute>
  ...
  <Route
    path="/student/question/exam/:examId"
    element={
      <ProtectedRoute allowedRoles={["student"]}>
        <HsTakeExamPage />
      </ProtectedRoute>
  ...
  <Route
    path="/student/question/exam/:examId/score"
    element={
      <ProtectedRoute allowedRoles={["student"]}>
        <HsTakeScorePage />
      </ProtectedRoute>
  ...
  <Route
    path="/student/question/exam/:examId/ready"
    element={
      <ProtectedRoute allowedRoles={["student"]}>
        <HsReadyPage />
      </ProtectedRoute>
