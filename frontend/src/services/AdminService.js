...
const addNewTeacherSimple = async (data) => {
  ...
  const response = await axiosInstance.post(
    "/api/admin/teachers/register-simple",
    data
  );
  return response;
};
...
const addNewTeacherNoValidation = async (data) => {
  ...
  const response = await axiosInstance.post(
    "/api/admin/teachers/register-no-validation",
    data
  );
  return response;
};
...
const updateStudentByAdmin = async (studentId, data) => {
  const response = await axiosInstance.put(
    `/api/admin/students/update/${studentId}`,
    data
  );
  return response.data;
};
...
const updateTeacherByAdmin = async (teacherId, data) => {
  const response = await axiosInstance.put(
    `/api/admin/teachers/update/${teacherId}`,
    data
  );
  return response.data;
};
...
const deleteStudentById = async (studentId) => {
  const response = await axiosInstance.delete(
    `/api/admin/student/delete/${studentId}`
  );
  return response.data;
};
...
const deleteTeacherById = async (teacherId) => {
  const response = await axiosInstance.delete(
    `/api/admin/teacher/delete/${teacherId}`
  );
  return response.data;
};
...
const searchUsers = async (params) => {
  ...
  const response = await axiosInstance.get(
    `/api/admin/users/search?${queryParams.toString()}`
  );
  return response.data;
};
